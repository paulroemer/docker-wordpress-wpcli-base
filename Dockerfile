...
RUN curl -o /tmp/advanced-custom-fields.zip https://downloads.wordpress.org/plugin/advanced-custom-fields.5.7.12.zip &&\
    curl -o /tmp/advanced-code-editor.zip https://downloads.wordpress.org/plugin/advanced-code-editor.2.2.7.zip &&\
    curl -o /tmp/importer.zip https://downloads.wordpress.org/plugin/wordpress-importer.0.6.4.zip &&\
    curl -o /tmp/wp-scss.zip https://downloads.wordpress.org/plugin/wp-scss.1.2.4.zip &&\
    curl -o /tmp/wpide.zip https://downloads.wordpress.org/plugin/wpide.2.4.0.zip &&\
    curl -o /tmp/tinymce.zip https://downloads.wordpress.org/plugin/tinymce-advanced.5.1.0.zip &&\
